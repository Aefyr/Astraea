...
import com.aefyr.sombra.diary.DeepMark;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private String sId;
    private int lId;
    private int pSId; //Period subject id
    private String pId; //Period id
                                                ...
                                                new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getMarks(sId, 0, new Diary.MarksListener() {
                                                    ...
                                                    public void onSuccess(ArrayList<Period> result) {
                                                        ...
                                                        for(Period p: result){
                                                            ...
                                                            System.out.println("Subject name: "+p.subjectName());
                                                            pSId = p.subjectId();
                                                            pId = p.id();
                                                        }
                                                        stat.setText(periods.toString());
                                                        setMessage("Fetching Data (5/9)");
                                                        ...
                                                        new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getHomework(sId, "2017-09-01", "2017-09-07", new Diary.HomeworkListener() {
                                                            ...
                                                            public void onSuccess(ArrayList<HomeworkDay> result) {
                                                                ...
                                                                new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getDeepLesson(sId, lId, new Diary.DeepLessonListener() {
                                                                    @Override
                                                                    public void onSuccess(DeepLesson result) {
                                                                        ...
                                                                        new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getSkips(sId, "2016-08-01", "2017-10-08", new Diary.SkipsListener() {
                                                                            ...
                                                                            public void onSuccess(ArrayList<DayWithSkips> result) {
                                                                                ...
                                                                                setMessage("Fetching Data (8/9)");
                                                                                new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getAttestationPeriodsBySubject(sId, pSId, new Diary.AttestationMarksListener() {
                                                                                    @Override
                                                                                    public void onSuccess(ArrayList<AttestationPeriod> result) {
                                                                                        ...
                                                                                        setMessage("Fetching Data (9/9)");
                                                                                        new Diary(SombraCore.getInstance(LoginActivity.this, AccountManager.getInstance(LoginActivity.this).getToken())).getMarksInPeriod(sId, pId, pSId, new Diary.PeriodMarksListener() {
                                                                                            @Override
                                                                                            public void onSuccess(ArrayList<DeepMark> result) {
                                                                                                stat.setText(result.get(0).topic());
                                                                                                showProgress(false);
                                                                                                setMessage("Done!");
                                                                                            }
